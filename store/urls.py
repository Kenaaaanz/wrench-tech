...
urlpatterns = [
    ...
    # URLs for Vendor 
    path('vendor/', views.vendor_landing, name='vendor_landing'),
    path('accounts/vendor_register/', views.vendor_register, name="vendor_register"),
    ...
    path('vendor/orders/<int:pk>/update-status/', views.vendor_update_order_status, name='vendor_update_order_status'),
